    ...
    var n = "assets/img/site_assets/",
        ...
        i = [
            ...
            },
            {
                ...
                thumbnail: "longye.jpg"
            },
            {
                nid: "shaoxiayingfengren",
                names: {
                    "en": "shaoxiayingfengren",
                    "cn": "少侠应奉仁",
                    "tw": "少侠应奉仁"
                },
                thumbnail: "shaoxiayingfengren.jpg"
            },
            {
                nid: "fuyayu",
                names: {
            ...
            },
            {
                ...
                thumbnail: "zhenyin.jpg"
            },
            {
                nid: "mohuahuangfushen",
                names: {
                    "en": "mohuahuangfushen",
                    "cn": "魔化皇甫申",
                    "tw": "魔化皇甫申"
                },
                thumbnail: "mohuahuangfushen.jpg"
            },
            {
                nid: "yunjia",
                names: {
        ...
        c = [
            ...
            { target: 2, type: "ban", amt: 1, label: "second", text: { en: "Ban 2 units from Player 1's Box", cn: "从P2 Ban 1 位人物", tw: "從P2 Ban 1 位人物" } },
            { target: 1, type: "pick", amt: 1, label: "first", text: { en: "Player 1 Picks 1 unit", cn: "P1 Pick 1 位人物", tw: "P1 Pick 1 位人物" } },
            { target: 1, type: "ban", amt: 1, label: "second", text: { en: "Ban 1 units from Player 1's Box", cn: "从P1 Ban 1 位人物", tw: "從P1 Ban 1 位人物" } },
            ...
            { target: 2, type: "pick", amt: 2, label: "third", text: { en: "Player 2 Picks 2 unit", cn: "P2 Pick 2 位人物", tw: "P2 Pick 2 位人物" } },
            { target: 2, type: "ban", amt: 2, label: "fourth", text: { en: "Ban 2 units from Player 2's Box", cn: "从P2 Ban 2 位人物", tw: "從P2 Ban 2 位人物" } },
            { target: 1, type: "pick", amt: 2, label: "third", text: { en: "Player 1 Picks 2 unit", cn: "P1 Pick 2 位人物", tw: "P1 Pick 2 位人物" } },
        ...
        return (
            t(),
            {
                ...
                createTimeline: function (t) {
                    ...
                    for (var j=0;j<t.p1.remain.length;j++){
                    (
                            n +=
